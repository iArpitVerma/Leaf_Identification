                    ...
                    child: ListView(
                      children: const [
                        ListTile(
                            ...
                            title: Text(
                              'Select a photo of the lead from your device by tapping the icon button at the bottom of the page.',
                              style: TextStyle(color: kWhite),
                            )),
                        ListTile(
                          leading: CircleAvatar(
                          ...
                          title: Text(
                              'The photo should contain a single leaf of the plant to be identified and be taken on plain background (preferably white sheet).',
                              style: TextStyle(color: kWhite)),
                        ),
                      ],
                    ),
